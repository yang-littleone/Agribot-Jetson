...
#include "yesense_interface/msg/detail/nav_all__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yesense_interface::msg::Quat &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const yesense_interface::msg::SensorTemp &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yesense_interface::msg::SensorTemp &);
size_t get_serialized_size(
  const yesense_interface::msg::SensorTemp &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const yesense_interface::msg::GnssPos &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yesense_interface::msg::GnssPos &);
size_t get_serialized_size(
  const yesense_interface::msg::GnssPos &,
  size_t current_alignment);
size_t
max_serialized_size_GnssPos(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
bool cdr_serialize(
  const yesense_interface::msg::NavStatus &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yesense_interface::msg::NavStatus &);
size_t get_serialized_size(
  const yesense_interface::msg::NavStatus &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const yesense_interface::msg::Vel &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const yesense_interface::msg::Utc &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yesense_interface::msg::Utc &);
size_t get_serialized_size(
  const yesense_interface::msg::Utc &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const yesense_interface::msg::NavAll & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface::msg::NavAll & ros_message)
{
  // Member: tid
  ...
  size_t current_alignment)
{
  ...
  // Member: quat
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_Quat(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: temp
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_SensorTemp(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: pos
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_GnssPos(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_NavStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: vel
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_Vel(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: utc
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_Utc(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface::msg::NavAll;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yesense_interface::msg::NavAll *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yesense_interface::msg::NavAll *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NavAll__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yesense_interface::msg::NavAll *>(
...
static size_t _NavAll__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NavAll(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NavAll__callbacks = {
...
static rosidl_message_type_support_t _NavAll__handle = {
...
{
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_NavAll__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, NavAll)() {
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_NavAll__handle;
}
