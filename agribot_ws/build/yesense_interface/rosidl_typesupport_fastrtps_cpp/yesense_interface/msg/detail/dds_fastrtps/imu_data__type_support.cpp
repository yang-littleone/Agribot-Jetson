...
#include "yesense_interface/msg/detail/imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yesense_interface::msg::SampleTimestamp &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yesense_interface::msg::SampleTimestamp &);
size_t get_serialized_size(
  const yesense_interface::msg::SampleTimestamp &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const yesense_interface::msg::ImuData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface::msg::ImuData & ros_message)
{
  // Member: tid
  ...
  size_t current_alignment)
{
  ...
  // Member: sample_timestamp
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_SampleTimestamp(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface::msg::ImuData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yesense_interface::msg::ImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yesense_interface::msg::ImuData *>(
    untyped_ros_message);
...
{
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, ImuData)() {
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
