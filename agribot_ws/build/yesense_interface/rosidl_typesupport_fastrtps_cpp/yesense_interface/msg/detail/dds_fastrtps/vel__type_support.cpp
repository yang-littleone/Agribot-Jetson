...
#include "yesense_interface/msg/detail/vel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yesense_interface::msg::Vel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface::msg::Vel & ros_message)
{
  // Member: vel_e
  cdr >> ros_message.vel_e;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface::msg::Vel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yesense_interface::msg::Vel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yesense_interface::msg::Vel *>(
    untyped_ros_message);
...
get_message_type_support_handle<yesense_interface::msg::Vel>()
{
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_Vel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, Vel)() {
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_Vel__handle;
}
