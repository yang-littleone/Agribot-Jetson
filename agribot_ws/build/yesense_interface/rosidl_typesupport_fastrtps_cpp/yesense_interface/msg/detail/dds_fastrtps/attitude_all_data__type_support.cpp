...
#include "yesense_interface/msg/detail/attitude_all_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yesense_interface::msg::AttitudeMinAhrs &,
  ...
  size_t current_alignment)
{
  ...
  // Member: att_min_ahrs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_AttitudeMinAhrs(
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface::msg::AttitudeAllData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yesense_interface::msg::AttitudeAllData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yesense_interface::msg::AttitudeAllData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AttitudeAllData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yesense_interface::msg::AttitudeAllData *>(
...
static size_t _AttitudeAllData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AttitudeAllData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AttitudeAllData__callbacks = {
...
static rosidl_message_type_support_t _AttitudeAllData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AttitudeAllData__callbacks,
...
{
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_AttitudeAllData__handle;
}
