...
#include "yesense_interface/msg/detail/robot_lord__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yesense_interface::msg::RobotLord & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface::msg::RobotLord & ros_message)
{
  // Member: tid
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface::msg::RobotLord;
    is_plain =
      (
...
static bool _RobotLord__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const yesense_interface::msg::RobotLord *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _RobotLord__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<yesense_interface::msg::RobotLord *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotLord__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yesense_interface::msg::RobotLord *>(
...
static size_t _RobotLord__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_RobotLord(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotLord__callbacks = {
  "yesense_interface::msg",
  "RobotLord",
  _RobotLord__cdr_serialize,
  _RobotLord__cdr_deserialize,
  _RobotLord__get_serialized_size,
  _RobotLord__max_serialized_size
};

static rosidl_message_type_support_t _RobotLord__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotLord__callbacks,
...
{
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_RobotLord__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, RobotLord)() {
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_RobotLord__handle;
}
