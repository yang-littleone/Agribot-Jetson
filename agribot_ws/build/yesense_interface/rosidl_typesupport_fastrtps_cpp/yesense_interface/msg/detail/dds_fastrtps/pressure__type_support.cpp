...
#include "yesense_interface/msg/detail/pressure__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yesense_interface::msg::Pressure & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface::msg::Pressure & ros_message)
{
  // Member: val
  cdr >> ros_message.val;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface::msg::Pressure;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yesense_interface::msg::Pressure *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yesense_interface::msg::Pressure *>(
    untyped_ros_message);
...
static size_t _Pressure__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Pressure(full_bounded, is_plain, 0);
...
get_message_type_support_handle<yesense_interface::msg::Pressure>()
{
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_Pressure__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, Pressure)() {
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_Pressure__handle;
}
