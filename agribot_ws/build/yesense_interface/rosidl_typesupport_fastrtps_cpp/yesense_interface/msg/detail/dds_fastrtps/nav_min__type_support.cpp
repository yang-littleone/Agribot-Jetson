...
#include "yesense_interface/msg/detail/nav_min__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const yesense_interface::msg::PosOnly &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  yesense_interface::msg::PosOnly &);
...
cdr_serialize(
  const yesense_interface::msg::NavMin & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface::msg::NavMin & ros_message)
{
  // Member: pos
  ...
  size_t current_alignment)
{
  ...
  // Member: pos
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        yesense_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_PosOnly(
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface::msg::NavMin;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yesense_interface::msg::NavMin *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yesense_interface::msg::NavMin *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NavMin__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yesense_interface::msg::NavMin *>(
...
static size_t _NavMin__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NavMin(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NavMin__callbacks = {
...
static rosidl_message_type_support_t _NavMin__handle = {
...
get_message_type_support_handle<yesense_interface::msg::NavMin>()
{
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_NavMin__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, NavMin)() {
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_NavMin__handle;
}
