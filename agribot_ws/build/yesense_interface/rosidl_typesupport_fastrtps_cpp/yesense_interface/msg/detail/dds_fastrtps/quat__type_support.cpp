...
#include "yesense_interface/msg/detail/quat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yesense_interface::msg::Quat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface::msg::Quat & ros_message)
{
  // Member: q0
  cdr >> ros_message.q0;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface::msg::Quat;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yesense_interface::msg::Quat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yesense_interface::msg::Quat *>(
    untyped_ros_message);
...
{
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_Quat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, Quat)() {
  return &yesense_interface::msg::typesupport_fastrtps_cpp::_Quat__handle;
}
